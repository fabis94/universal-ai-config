...
List files in `.universal-ai-config/instructions/` to discover existing instruction templates. Read their frontmatter to understand what each covers and its scope.
...
1. Create a `.md` file in `.universal-ai-config/instructions/` with a descriptive name (e.g. `error-handling.md`)
